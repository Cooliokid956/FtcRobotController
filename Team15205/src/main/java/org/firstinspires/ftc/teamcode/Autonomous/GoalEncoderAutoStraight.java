...
@Autonomous(name = "GoalEncoderStraight", group = "OpModes")
public class GoalEncoderAutoStraight extends LinearOpMode {
//    public enum Seq{
//        ONE,
//        TWO,
//        THREE
...
//
    public void runOpMode() {
        ...
        */
        robot.encoderDrive(STRAFE_SPEED, 30, 30, 30, 30, 20.0);//move right
